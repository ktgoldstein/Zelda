...
{
    class TrackingFireball : IEnemyProjectile
    {
        ...
        public IEnemy EnemyCaster;


        public TrackingFireball(IEnemy casterEnemy, Vector2 location, Vector2 direction, int lifespan = -1)
        {
