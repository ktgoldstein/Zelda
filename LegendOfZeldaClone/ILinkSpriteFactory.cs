...
namespace LegendOfZeldaClone
{
    public class LinkSpriteFactory
    {
        ...
        public ILinkSprite CreateLinkStandingDownSprite(LinkSkinType skinOffset, int frame = 0)
        {
        ...
        public ILinkSprite CreateLinkStandingUpSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkStandingLeftSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkStandingRightSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkWalkingDownSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
            int xOffset = (spriteHeight + atlasGap) * (int)LinkSpriteType.FacingDown;
        ...
        public ILinkSprite CreateLinkWalkingUpSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
            int xOffset = (spriteHeight + atlasGap) * (int)LinkSpriteType.FacingUp;
            return new LinkWalkingSprite(linkSpriteSheet, xOffset, yOffset, spriteWidth, spriteHeight, atlasGap, frame);
        ...
        public ILinkSprite CreateLinkWalkingLeftSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
            int xOffset = (spriteHeight + atlasGap) * (int)LinkSpriteType.FacingLeft;
            return new LinkWalkingSprite(linkSpriteSheet, xOffset, yOffset, spriteWidth, spriteHeight, atlasGap, frame);
        ...
        public ILinkSprite CreateLinkWalkingRightSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
            int xOffset = (spriteHeight + atlasGap) * (int)LinkSpriteType.FacingRight;
            return new LinkWalkingSprite(linkSpriteSheet, xOffset, yOffset, spriteWidth, spriteHeight, atlasGap, frame);
        ...
        public ILinkSprite CreateLinkUsingItemDownSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkUsingItemUpSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkUsingItemLeftSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkUsingItemRightSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
        ...
        public ILinkSprite CreateLinkPickingUpItemSprite(LinkSkinType skinOffset, int frame = 0)
        {
            int yOffset = (spriteHeight + atlasGap) * (int)skinOffset;
            int xOffset = (spriteHeight + atlasGap) * (int)LinkSpriteType.UsingItemDown;
