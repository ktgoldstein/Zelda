...
{
    public class LinkPickingUpTriforceSprite : ILinkSprite
    {
        ...
        public LinkPickingUpTriforceSprite(Texture2D texture, int x, int y, int spriteWidth, int spriteHeight, int spriteAtlasGap, int currentFrame)
        {
