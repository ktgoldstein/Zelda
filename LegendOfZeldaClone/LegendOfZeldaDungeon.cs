...
namespace LegendOfZeldaClone
{
    public class LegendOfZeldaDungeon : Game
    {
        ...
        private Direction DetectCollisionDirection(Vector2 location1, int width1, int height1, Vector2 location2, int width2, int height2)
        {
        ...
        private float FindOverlap(float start1, int length1, float start2, int length2)
        {
