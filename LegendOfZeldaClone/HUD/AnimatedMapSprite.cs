...
{
    public class AnimatedMapSprite : ISprite
    {
        ...
        public AnimatedMapSprite(Texture2D texture, int columns, int rows, int atlasGap, int totalFrames, int animationSpeed = 5, Color? color = null)
        {
